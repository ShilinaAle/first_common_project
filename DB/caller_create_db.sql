...
INSERT INTO Calls (id_call, user_id, recipient_number, call_date_time, callback_date_time)
VALUES
(1, 1, '88001001010', '2022-01-01 12:00', '2022-01-02 12:00'),
(2, 1, '8-800-200-20-20', '2022-02-02 14:00', '2022-02-02 14:30')
#,(3, 5, '111222', '2005-05-05 12:55', '2005-05-06 12:00') #строка не пройдет,так как нет пользователя с id = 5
#,(4, null, null, null, null) #строка не пройдет, так как поял не могут принимать значение null
;
SELECT * FROM Calls;
